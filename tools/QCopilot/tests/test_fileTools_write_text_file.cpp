...
int main() {
    ...
    auto r = BuiltinTools::FileTools::executeWriteTextFile(j);
    ...
    auto r2 = BuiltinTools::FileTools::executeWriteTextFile(j2);
    ...
    // 错误：空路径
    auto r3 = BuiltinTools::FileTools::executeWriteTextFile({{"path",""},{"content","x"}});
