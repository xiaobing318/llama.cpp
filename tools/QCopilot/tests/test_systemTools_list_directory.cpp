...
int main(){
    ...
    BuiltinTools::FileTools::executeWriteTextFile({{"path", (root/".secret").u8string()}, {"content","x"}});

    auto r1 = BuiltinTools::SystemTools::executeListDirectory({{"path", root.u8string()}, {"recursive", false}, {"show_hidden", false}});
    ...
    auto r2 = BuiltinTools::SystemTools::executeListDirectory({{"path", root.u8string()}, {"recursive", true}, {"show_hidden", true}});
