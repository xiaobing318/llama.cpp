...
int main(){
    ...
    auto j1 = BuiltinTools::TimeTools::run_get_current_time({{"format","ISO8601"},{"timezone","UTC"}});
    ...
    auto j2 = BuiltinTools::TimeTools::run_get_current_time({{"format","unix"}});
    ...
    auto j3 = BuiltinTools::TimeTools::run_get_current_time({{"format","default"}});
